...
def test_quotes_are_converted_before_values_percentages_and_trades():
    ...
    registry.get_quotes_for_assets.return_value = {
    ...
    assert by_ticker["EUR_ASSET"].current_percentage == Decimal("10000") / total
    assert by_ticker["USD_ASSET"].current_percentage == usd_value * 100 / total
